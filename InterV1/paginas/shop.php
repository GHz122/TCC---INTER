                    ...
                    <figure class="figure-shop">
                        ...
                        <figcaption>
                            ...
                            <div class="btnCarrinho-shop">
                                ...
                                <a class="linkCarrinho-shop" href="?adicionar=<?php echo $key;?>"><button onclick="pegarID()">Carrinho<span style="display: none;"><?php echo $row['p_nome'];?></span></button></a>
                            </div> 
                        </figcaption>
                    </figure>
                <?php 
...
<?php 
    ...
    //     echo "<p>"."quantidade:" .$value['quantidade']. $value['nome'] .$value['preco']. "</p>";
    // }
